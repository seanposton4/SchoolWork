...
#look at the number of confirmed cases, deaths and recovered patients worldwide
...
def update_csv(file, df):
  ...
  #store the data received on the previous day and assume no change if no available data
        yesterday = str(
            (datetime.strptime(
                today,
                "%d-%m-%y") -
...
#identify which countries are missing in the API’s response this time
