...
public class JTOBParseTree
{
    ...
    public JTOBParseTree(JTOB parser)
    {
        sym = new SymbolTable();
        this.parser = parser;
    }
	...
	public class IfNode extends StatementNode
    {
        private RefNode condition;
        private StatementListNode body;
        private StatementListNode yysv; //this should be the else

        public IfNode(RefNode condition, StatementListNode body) {
            this.condition = condition;
            this.body = body;
        }

        public IfNode(RefNode condition, StatementListNode body, StatementListNode yysv) {
            this.condition = condition;
            this.body = body;
            this.yysv = yysv; 
        }
	...
	//For Loop Node
    public class FloopNode extends StatementNode
    {
        private RefNode left; 
		private RefNode right;
        private StatementListNode body;

        //create a new while node
        public FloopNode(RefNode left, RefNode right, StatementListNode body) {
            this.left = left;
			this.right = right;
            this.body = body;
        }
	...
	public class LogicNode implements ParseNode
    {
        protected ParseNode left;
        protected String op;
        protected ParseNode right;
        ...
        //construct the binary operator node
        public LogicNode(ParseNode left, String op, ParseNode right) {
            this.left =  left;
            this.op = op;
            this.right = right;
        }
        ...
        public Object evaluate() {
            ...
            //evaluate the operands
            //Boolean lval = (Boolean) left.evaluate();
            //Boolean rval = (Boolean) right.evaluate();

            //perform the operatin
            /*switch(op)
            {
                case ">":
                    return lval > rval;
   ...
   public class RefNode implements ParseNode
   {
	...
	public class StringNode implements ParseNode
    {
        String val;
    ...
    public class CharacterNode implements ParseNode
    {
        char val;

        //create the literal
        public CharacterNode(char val) {
            this.val = val;
        }
